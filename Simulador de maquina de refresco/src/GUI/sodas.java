...
public class sodas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Cocas a $17 pesos!!!!!");
...
if((eleccioncoca.getText() == null)){
    System.out.println("Hola");
        ...
        if(Integer.valueOf(cantidad.getText()) > 500){
            JOptionPane.showMessageDialog(this, "No hay tanto cambio\nLo siento", "Dinero", JOptionPane.ERROR_MESSAGE );
        }
        if(Integer.valueOf(cantidad.getText()) < 17){
            JOptionPane.showMessageDialog(this, "Te falta dinero", "Dinero", JOptionPane.ERROR_MESSAGE );
        }
        if((Integer.valueOf(cantidad.getText()) >= 17)&&(Integer.valueOf(cantidad.getText()) <= 500)){
            Integer cambio = (Integer.valueOf(cantidad.getText())) - 17;
